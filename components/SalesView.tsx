...
import { Target, TrendingUp, Trophy, Bell, Plus, Edit2, DollarSign, Link, Clipboard, UserCheck, Info, CheckCircle2 } from 'lucide-react';
        ...
        <div className="xl:col-span-2 space-y-8">
          {isSales && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#111] border border-white/5 rounded-[32px] p-8 space-y-6 shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <button onClick={handleConfirmSale} className="w-full bg-[#14b8a6] text-black py-4 rounded-xl font-black text-sm hover:scale-[1.02] transition-all uppercase shadow-[0_10px_30px_rgba(20,184,166,0.3)]">
          ...
          <div className="bg-[#111] border border-white/5 rounded-[32px] p-10 relative overflow-hidden group shadow-2xl">
             ...
             <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-black/40 p-6 rounded-3xl border border-white/5 text-center shadow-lg">
          ...
          <div className="bg-[#111] border border-white/5 rounded-[32px] p-8 space-y-6 h-full flex flex-col shadow-2xl">
            ...
            <div className="space-y-4 flex-1 overflow-y-auto pr-2 custom-scrollbar">
              {sellers.map((seller, index) => (
                <div key={seller.id} className={`flex flex-col p-5 rounded-3xl border transition-all duration-500 ${getSellerStatusClass(seller)} shadow-sm`}>
